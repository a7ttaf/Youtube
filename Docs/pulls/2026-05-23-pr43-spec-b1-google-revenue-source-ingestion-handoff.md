...
- Full suite (with `UMS_TEST_DATABASE_URL=postgresql+psycopg://postgres:ums@localhost:55432/postgres`): **959 passed in ~105s** (910 original + 49 review-hardening regression tests added during Codex/CodeRabbit review).
