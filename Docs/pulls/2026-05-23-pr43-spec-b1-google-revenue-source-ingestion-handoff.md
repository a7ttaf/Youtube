...
- Full suite (with `UMS_TEST_DATABASE_URL=postgresql+psycopg://postgres:ums@localhost:55432/postgres`): **946 passed in ~120s** (910 original + 36 review-hardening regression tests added during Codex/CodeRabbit review).
