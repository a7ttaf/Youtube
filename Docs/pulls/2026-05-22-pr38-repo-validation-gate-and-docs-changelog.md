...
Current review-loop validation tracks 42 pytest-policy tests and 5 quality-gate
...
- **Pytest count:** 795 after the review-loop validation regression tests.

## Test surface change

- Pytest total: 795 after the review-loop validation regression tests.
- 47 devtools tests now tracked in git (42 policy + 5 quality gate); +1 test subdirectory now tracked.
