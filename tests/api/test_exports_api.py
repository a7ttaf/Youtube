        ...
        raw_payload=(
            {
                ...
                # Projecting Analytics rows carry a dimensions object; the export
                # fence now matches the fail-closed Python fences, so a missing
                # or non-object dimensions key excludes the row.
                "dimensions": {"channel": channel_id, "month": month},
            }
