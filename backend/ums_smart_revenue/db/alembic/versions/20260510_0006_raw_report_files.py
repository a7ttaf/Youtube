...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column("parse_status", sa.Text(), nullable=False, server_default=sa.text("'DOWNLOADED'")),
    ...
    op.create_index("ix_raw_report_files_source_month", "raw_report_files", ["source", "report_month"])
    op.create_index("ix_raw_report_files_report_type_month", "raw_report_files", ["report_type", "report_month"])
