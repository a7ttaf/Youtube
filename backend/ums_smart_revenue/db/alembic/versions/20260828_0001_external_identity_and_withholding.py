...
# Standards: Dependency-ordered DDL owned by this revision; rollback lands on
#   20260913_0001, above the gated and irreversible security-floor revisions.
...
# ============================================================================
def downgrade() -> None:
    """Drop only this revision; earlier teardown stays behind the 20260911 gate."""
    bind = op.get_bind()
    op.drop_index(
        "ix_us_withholding_rate_configs_tenant_effective",
