...
_SHEET_SOURCES = {
    ...
    "Sector Breakdown": "channel_registry_revenue_facts_deduction_components_and_account_allocations",
    "Channel Breakdown": "monthly_revenue_facts_deduction_components_and_account_allocations",
    "Deductions": "source_net_revenue_manual_overrides_deduction_components_and_account_allocations",
