...
_SHEET_SOURCES = {
    ...
    "Company Breakdown": "monthly_revenue_facts_and_account_allocations",
    "Sector Breakdown": "channel_registry_revenue_facts_and_account_allocations",
    "Channel Breakdown": "monthly_revenue_facts_and_account_allocations",
