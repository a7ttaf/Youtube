...
def _projecting_analytics_source_row_predicate(
    *,
    ...
    if dialect_name == "postgresql":
        # FIX: a missing `dimensions` key is MALFORMED_SOURCE_PAYLOAD to every
        # Python fence (normalizer, owner-channel, deductions); admitting it
        # here exported rows that can never project. Require a JSON object.
