...
BOOTSTRAP_ORG_UNITS = [
    ...
    OrgUnitRow(id=BOOTSTRAP_SECTOR_NEWS_ID, parent_id=None, type="SECTOR", name="News", active=True),
    OrgUnitRow(
...
BOOTSTRAP_CHANNELS = [
    ChannelRegistryRow(youtube_channel_id="channel-tv-a", primary_org_unit_id=BOOTSTRAP_COMPANY_TV_ID, active=True),
    ChannelRegistryRow(
