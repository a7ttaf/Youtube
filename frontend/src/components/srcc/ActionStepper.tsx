...
//   introduced. Cancel is disable-able by the caller
...
//   disabled Cancel always states why. .steps carries a 6-column default
//   (inherited from the mock month-close rail that has since been deleted, and
//   now only a fallback); an inline gridTemplateColumns override sizes it to the
//   caller's actual step count so a 3-step (or any N-step) flow lays out evenly
