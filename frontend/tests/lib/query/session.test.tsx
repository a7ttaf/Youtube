...
const SESSION_BODY: SessionMe = {
  ...
  tenant: { id: "tenant-1", slug: "ums", display_name: "UMS", primary_currency: "USD" },
  roles: [],
  permissions: [],
...
const TENANT_A = { id: "tenant-1", slug: "tenant-a", display_name: "Tenant A", primary_currency: "USD" };
const TENANT_B = { id: "tenant-2", slug: "tenant-b", display_name: "Tenant B", primary_currency: "USD" };
...
describe("useSessionMeQuery", () => {
  ...
  it("does not hydrate principal A or tenant A when a provider remounts for principal B", async () => {
    ...
    const principalB = sessionFor("principal-b", {
      tenant: { id: "tenant-2", slug: "tenant-b", display_name: "Tenant B", primary_currency: "USD" },
    });
